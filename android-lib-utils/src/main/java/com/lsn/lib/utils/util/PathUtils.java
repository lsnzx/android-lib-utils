...
public final class PathUtils {
    ...
    /**
     * Return the path of /storage/emulated/0/fileName.
     *
     * @return the path of /storage/emulated/0/fileName
     */
    public static String getExternalFileNamePath(String fileName) {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Environment.getExternalStoragePublicDirectory(fileName));
    }
